...
- **标准磁力片形状库**: 共 13 种, 分核心/扩展两层 (见 `docs/TILE_SET.md`) —— 核心 9 种: 正方形、大正方形、窗格方、门框方、等边三角形、直角三角形、等腰三角形、长方形、车轮底座; 扩展 4 种: 菱形、梯形、六边形、扇形。几何数据由 `data/tile_catalog.json` 驱动, 可扩展非标配件。
