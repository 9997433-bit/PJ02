...
全库 250 个模型聚成 **185 族**: 多成员族 52 个 (共 117 模型, 折叠 65 个重复原型), 单模型族 133 个 (D2 x15, D3 x94, D4 x23, D5 x1)。片型直方图是**备料构成**视角, 不含连接拓扑 —— 同族成员工序仍可能不同, 这是缓建须人工签核而非自动豁免的根本原因。
...
| F029 | 2 | D3 | 动物世界、自然、自然世界 | 0.749 | **`crocodile_01`** `hedgehog_01` |
...
| F034 | 2 | D3 | 海洋、海洋航行 | 0.698 | **`fireboat_01`** `whale_01` |
| F035 | 2 | D2 | 城市、城市生活、职业体验 | 0.703 | **`forklift_01`** `tow_truck_01` |
| F036 | 2 | D4 | 海洋航行、港口 | 0.723 | `harbor_crane_01` **`submarine_dock_01`** |
| F037 | 2 | D4 | 城市生活 | 0.720 | **`helicopter_01`** `library_building_01` |
| F038 | 2 | D3 | 工程、工程结构 | 0.701 | **`hydro_dam_01`** `solar_farm_01` |
| F039 | 2 | D3 | 海岸、海洋航行 | 0.706 | **`lighthouse_pier_01`** `whale_watching_01` |
| F040 | 2 | D3 | 航天探索 | 0.681 | `lunar_lander_01` **`radio_telescope_01`** |
| F041 | 2 | D3 | 航天、航天器、航天探索 | 0.749 | `moon_lander_01` **`space_shuttle_01`** |
| F042 | 2 | D3 | 交通、城市生活、火车 | 0.793 | **`mountain_rail_01`** `railway_crossing_01` |
| F043 | 2 | D3 | 动物世界、自然、自然世界 | 0.737 | **`owl_01`** `peacock_01` |
| F044 | 2 | D3 | 实验室 | 0.708 | `particle_accelerator_01` **`science_lab_01`** |
| F045 | 2 | D3 | 音乐 | 0.699 | `piano_stage_01` **`pipe_organ_01`** |
| F046 | 2 | D3 | 帆船、海洋、海洋航行 | 0.722 | **`pirate_ship_01`** `sailboat_01` |
| F047 | 2 | D4 | 树屋、自然、自然世界 | 0.700 | `rainforest_canopy_01` **`treehouse_01`** |
| F048 | 2 | D3 | 城市、城市生活 | 0.697 | `recycling_center_01` **`supermarket_01`** |
| F049 | 2 | D4 | 城市生活 | 0.704 | **`rescue_hq_01`** `stadium_gate_01`† |
| F050 | 2 | D3 | 农业、农场、田园 | 0.799 | **`rice_terrace_01`** `sheep_farm_01` |
| F051 | 2 | D3 | 航天、航天探索 | 0.686 | `satellite_dish_01` **`space_station_01`** |
| F052 | 2 | D4 | 建筑地标 | 0.695 | `temple_greek_01` **`triumphal_arch_01`** |
...
| F029 | `crocodile_01` | 大嘴鳄鱼 | D3 | 53 | 16 | — | 28.9 | 待复核 | 否 |
...
| F034 | `fireboat_01` | 消防喷水礼船 | D3 | 63 | 12 | `tall_wall_chain` | 33.5 | 待复核 | 否 |
| F035 | `forklift_01` | 叉车 | D2 | 46 | 10 | — | 22.0 | 待复核 | 否 |
| F036 | `submarine_dock_01` | 潜艇维修船坞 | D4 | 89 | 18 | `tall_wall_chain`、`critical_com_margin` | 50.4 | 待复核 | 否 |
| F037 | `helicopter_01` | 救援直升机 | D4 | 87 | 18 | `tall_wall_chain` | 45.3 | 待复核 | 否 |
| F038 | `hydro_dam_01` | 水电站大坝 | D3 | 62 | 16 | `tall_wall_chain` | 34.9 | 待复核 | 否 |
| F039 | `lighthouse_pier_01` | 灯塔栈桥 | D3 | 72 | 16 | `tall_wall_chain` | 43.4 | 待复核 | 否 |
| F040 | `radio_telescope_01` | 射电望远镜 | D3 | 62 | 16 | `tall_wall_chain`、`weak_edge_load_bearing` | 40.3 | 待复核 | 否 |
| F041 | `space_shuttle_01` | 航天飞机 | D3 | 68 | 15 | — | 31.1 | 待复核 | 否 |
| F042 | `mountain_rail_01` | 登山齿轨小火车 | D3 | 61 | 13 | `tall_wall_chain` | 35.8 | 待复核 | 否 |
| F043 | `owl_01` | 月夜猫头鹰 | D3 | 52 | 12 | `tall_wall_chain` | 34.6 | 待复核 | 否 |
| F044 | `science_lab_01` | 科学实验室 | D3 | 67 | 14 | `tall_wall_chain` | 34.6 | 待复核 | 否 |
| F045 | `pipe_organ_01` | 音乐厅管风琴 | D3 | 74 | 13 | `tall_wall_chain` | 38.8 | 待复核 | 否 |
| F046 | `pirate_ship_01` | 海盗船与藏宝码头 | D3 | 74 | 13 | `tall_wall_chain` | 36.4 | 待复核 | 否 |
| F047 | `treehouse_01` | 树屋 | D4 | 79 | 18 | `tall_wall_chain` | 47.2 | 待复核 | 否 |
| F048 | `supermarket_01` | 阳光超市 | D3 | 67 | 16 | `tall_wall_chain` | 35.2 | 待复核 | 否 |
| F049 | `rescue_hq_01` | 救援行动总部 | D4 | 101 | 18 | `tall_wall_chain` | 48.2 | 待复核 | 否 |
| F050 | `rice_terrace_01` | 梯田稻香 | D3 | 74 | 15 | `tall_wall_chain` | 35.2 | 待复核 | 否 |
| F051 | `space_station_01` | 轨道空间站 | D3 | 69 | 16 | `tall_wall_chain` | 37.9 | 待复核 | 否 |
| F052 | `triumphal_arch_01` | 凯旋门 | D4 | 88 | 18 | `tall_wall_chain` | 50.6 | 待复核 | 否 |
...
| 口径 | 模型数 | 实搭预算 |
| --- | ---: | ---: |
| 全集逐个实搭 (基线) | 46 | 3270 分钟 ≈ 54.5 小时 |
| 族去重后必搭 (代表 + 单模型族 + 抽样包成员) | 36 | 2570 分钟 ≈ 42.8 小时 |
| **可缓建 (须策展签核)** | **10** | **700 分钟 ≈ 11.7 小时 (省 21%)** |
...
| `harbor_crane_01` | D4 | F036 | `submarine_dock_01` | 70 分钟 |
| `library_building_01` | D4 | F037 | `helicopter_01` | 70 分钟 |
| `rainforest_canopy_01` | D4 | F047 | `treehouse_01` | 70 分钟 |
| `temple_greek_01` | D4 | F052 | `triumphal_arch_01` | 70 分钟 |
