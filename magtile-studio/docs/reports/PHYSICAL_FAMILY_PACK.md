...
- 风险分来源: 内置退化启发式 (physical_risk_report 未就位); 已复核判定与 `tools/list_physical_pending.py` 同源 (同一 classify 函数)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| F001 | `traffic_light_junction_01` | 红绿灯路口 | D3 | 74 | 13 | — | 55.7 | 待复核 | 否 |
| F002 | `fire_truck_01` | 消防车 | D3 | 69 | 16 | — | 54.1 | 待复核 | 否 |
| F003 | `kindergarten_01` | 彩虹幼儿园 | D3 | 61 | 16 | — | 56.8 | 待复核 | 否 |
| F004 | `dump_truck_01` | 自卸卡车 | D3 | 74 | 18 | — | 57.1 | 待复核 | 否 |
| F005 | `sandbox_park_01` | 沙坑公园 | D3 | 63 | 16 | — | 53.6 | 待复核 | 否 |
| F006 | `castle_tower_01` | 土丘要塞主塔 | D3 | 75 | 13 | — | 54.8 | 待复核 | 否 |
| F007 | `police_station_01` | 社区派出所 | D3 | 75 | 17 | — | 59.1 | 待复核 | 否 |
| F008 | `post_office_01` | 邮局 | D4 | 97 | 19 | — | 70.9 | 待复核 | 否 |
| F009 | `steam_locomotive_01` | 蒸汽机车 | D4 | 99 | 18 | — | 70.7 | 待复核 | 否 |
| F010 | `race_track_01` | 环形赛道 | D4 | 82 | 18 | — | 63.4 | 待复核 | 否 |
| F011 | `parking_garage_01` | 立体停车场 | D4 | 82 | 18 | — | 64.6 | 待复核 | 否 |
| F012 | `airport_terminal_02` | 登机廊桥航站楼 | D3 | 72 | 14 | — | 57.2 | 待复核 | 否 |
| F013 | `ball_run_tower_01` | 螺旋滚珠塔 | D4 | 90 | 19 | — | 66.4 | 待复核 | 是 |
| F014 | `lifeguard_tower_01` | 海滩救生站 | D2 | 48 | 11 | — | 37.7 | 待复核 | 否 |
| F015 | `chicken_coop_01` | 农场鸡舍 | D3 | 62 | 16 | — | 57.1 | 待复核 | 否 |
| F016 | `giraffe_01` | 长颈鹿 | D3 | 52 | 16 | — | 46.7 | 待复核 | 否 |
| F017 | `elephant_pavilion_01` | 大象馆 | D3 | 75 | 15 | — | 58.8 | 待复核 | 否 |
| F018 | `cabin_lake_01` | 湖边木屋 | D3 | 66 | 17 | — | 59.0 | 待复核 | 否 |
| F019 | `dinosaur_stego_01` | 低头觅食的剑龙 | D3 | 69 | 17 | — | 57.4 | 待复核 | 否 |
| F020 | `canoe_01` | 湖上独木舟 | D3 | 68 | 16 | — | 53.8 | 待复核 | 否 |
| F021 | `hangar_01` | 飞机维修机库 | D3 | 74 | 14 | — | 57.7 | 待复核 | 否 |
| F022 | `city_bus_stop_01` | 街头公交站 | D2 | 46 | 10 | — | 36.4 | 待复核 | 否 |
| F023 | `combine_harvester_01` | 联合收割机 | D3 | 74 | 14 | — | 56.5 | 待复核 | 否 |
| F024 | `road_construction_01` | 道路施工段 | D3 | 72 | 15 | — | 57.9 | 待复核 | 否 |
| F025 | `fishing_boat_01` | 渔船靠泊 | D3 | 63 | 16 | — | 51.1 | 待复核 | 否 |
| F026 | `suspension_bridge_01` | 海湾悬索桥 | D3 | 74 | 16 | — | 59.3 | 待复核 | 否 |
| F027 | `crocodile_01` | 大嘴鳄鱼 | D3 | 53 | 16 | — | 47.0 | 待复核 | 否 |
| F028 | `marching_band_01` | 军乐队巡游 | D3 | 74 | 14 | — | 54.0 | 待复核 | 否 |
| F029 | `fairy_castle_01` | 仙子天桥城堡 | D3 | 66 | 13 | — | 50.9 | 待复核 | 否 |
| F030 | `hanging_garden_01` | 空中花园 | D4 | 85 | 18 | — | 64.2 | 待复核 | 否 |
| F031 | `submarine_dock_01` | 潜艇维修船坞 | D4 | 89 | 18 | — | 64.1 | 待复核 | 否 |
| F032 | `helicopter_01` | 救援直升机 | D4 | 87 | 18 | — | 69.8 | 待复核 | 否 |
| F033 | `hydro_dam_01` | 水电站大坝 | D3 | 62 | 16 | — | 50.8 | 待复核 | 否 |
| F034 | `lighthouse_pier_01` | 灯塔栈桥 | D3 | 72 | 16 | — | 53.7 | 待复核 | 否 |
| F035 | `lunar_lander_01` | 月面着陆器 | D3 | 63 | 16 | — | 54.9 | 待复核 | 否 |
| F036 | `merry_go_round_01` | 旋转木马底座场景 | D3 | 75 | 16 | — | 55.8 | 待复核 | 否 |
| F037 | `space_shuttle_01` | 航天飞机 | D3 | 68 | 15 | — | 54.3 | 待复核 | 否 |
| F038 | `mountain_rail_01` | 登山齿轨小火车 | D3 | 61 | 13 | — | 50.8 | 待复核 | 否 |
| F039 | `particle_accelerator_01` | 环形粒子加速器 | D3 | 72 | 14 | — | 55.9 | 待复核 | 否 |
| F040 | `police_car_01` | 警车 | D3 | 53 | 16 | — | 47.0 | 待复核 | 否 |
| F041 | `rescue_hq_01` | 救援行动总部 | D4 | 101 | 18 | — | 70.1 | 待复核 | 否 |
| F042 | `sheep_farm_01` | 剪毛牧场 | D3 | 74 | 15 | — | 57.3 | 待复核 | 否 |
| F043 | `space_station_01` | 轨道空间站 | D3 | 69 | 16 | — | 57.9 | 待复核 | 否 |
| F044 | `temple_greek_01` | 希腊神庙 | D4 | 95 | 18 | — | 69.6 | 待复核 | 否 |
| F045 | `treehouse_02` | 双树树上小屋 | D4 | 99 | 18 | — | 72.0 | 待复核 | 是 |
...
| 族去重后必搭 (代表 + 单模型族 + 抽样包成员) | 34 | 2430 分钟 ≈ 40.5 小时 |
| **可缓建 (须策展签核)** | **11** | **770 分钟 ≈ 12.8 小时 (省 24%)** |

| 可缓建模型 | 难度 | 所在族 | 兜底代表 | 单模型预算 |
| --- | --- | --- | --- | ---: |
| `fire_station_01` | D4 | F008 | `post_office_01` | 70 分钟 |
| `pet_clinic_01` | D4 | F008 | `post_office_01` | 70 分钟 |
| `freight_yard_01` | D4 | F009 | `steam_locomotive_01` | 70 分钟 |
| `train_station_01` | D4 | F009 | `steam_locomotive_01` | 70 分钟 |
| `airport_terminal_01` | D4 | F011 | `parking_garage_01` | 70 分钟 |
| `marble_run_spiral_01` | D4 | F013 | `ball_run_tower_01` | 70 分钟 |
| `rainforest_canopy_01` | D4 | F030 | `hanging_garden_01` | 70 分钟 |
| `harbor_crane_01` | D4 | F031 | `submarine_dock_01` | 70 分钟 |
| `library_building_01` | D4 | F032 | `helicopter_01` | 70 分钟 |
| `triumphal_arch_01` | D4 | F044 | `temple_greek_01` | 70 分钟 |
| `treehouse_01` | D4 | F045 | `treehouse_02` | 70 分钟 |
