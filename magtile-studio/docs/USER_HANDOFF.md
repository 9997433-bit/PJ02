...
> 实跑: 249 通过 + 1 白名单豁免, D4+ 46x50 全绿) 及发布门禁报告
> (`9955aaa`: QA 250/250 + L2 46/46 全绿, 仅 L3 红 0/46) **已刷新至
> 250 基线**; 全量就绪 (`34aebfd`) 报告仍为 234 基线, 250 复跑进行中
> —— 结论不受扩容影响, R6/R7 实物复核仍为唯二 P0 FAIL。
...
清单 §8 S1/S2 实物复核 (用户侧) + 全量就绪报告 250 基线复跑收尾
(发布门禁 250 刷新已入库 `9955aaa`)。
...
3. **内容 234 → 250 已收官** (`2b2c4ff`, 内容批 F~I; L2 风险/结构族/strict 巡检/发布门禁报告已刷新至 250 基线): 剩余全量就绪报告 250 基线复跑收尾, 并输出主题/难度分布报表给 C5 人工终审当底稿 (缺口审计 250 复跑已入库 `a5ed585`);
