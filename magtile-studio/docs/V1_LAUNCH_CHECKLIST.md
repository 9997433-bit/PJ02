...
治理批 `324e1b9` 后 `--full` 档另挂难度配额 strict 守卫 —— D3 冻结
生效期间与 L3 并列**双红灯**, 口径见 §7 G2);
全量就绪探测留痕:
