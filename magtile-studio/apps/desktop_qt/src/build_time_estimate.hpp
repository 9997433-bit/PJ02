...
// =============================================================
// MagTile Studio (Qt) - 详情页「预计用时」估算 (QT-1, UI_UX_SPEC §5.4)
//
...
// 超出最大档一律封顶 45 分钟。
//
// 纯函数、纯头文件、零 Qt 依赖: StudioBackend::modelDetail 与
// 单测 (ctest: qt_build_time_estimate) 共用同一实现。
// =============================================================

namespace magtile::qtui {

/// 用时档位表 (分钟, 升序): 详情页展示的全部可能取值。
